...
#    ✅ /path/to/worktree/phase-1-auth/src/__tests__/api/auth.test.ts
```
...
출력:
- API 테스트 파일 (src/__tests__/api/*.test.ts)
- 컴포넌트 테스트 파일 (src/__tests__/components/*.test.tsx)
- E2E 테스트 (e2e/*.spec.ts)
