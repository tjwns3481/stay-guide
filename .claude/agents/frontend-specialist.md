...
description: Frontend specialist for Next.js App Router, Clerk auth, Zustand state, and TailwindCSS. Use proactively for frontend tasks.
...
# 2. 테스트 실행 → 반드시 실패해야 함
cd frontend && npm run test -- src/__tests__/auth/
